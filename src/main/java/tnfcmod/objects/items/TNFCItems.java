...
public class TNFCItems
{
    ...
    public static IEMetalPressMold mold_grill = new IEMetalPressMold("mold_grill").setCreativeTab(CT_MISC);
    ...
    public static IEMetalPressMold mold_mace = new IEMetalPressMold("mold_chisel").setCreativeTab(CT_MISC);
    ...
    public static FluidWrapper LUBRICANT;
