...
public class ArmorMaterialsTNFC
{
    ...
    public static final IArmorMaterialTFC ZIRCALOY = new ArmorMaterialTFC(EnumHelper.addArmorMaterial("tnfc_zircaloy", TerraFirmaCraft.MOD_ID + ":zircaloy", 120, new int[] {2, 8, 8, 3}, 17, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 8.0F), 50, 25, 25);
