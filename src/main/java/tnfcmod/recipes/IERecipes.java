...
public class IERecipes
{
    ...
    {
        //Mold recipes
        Ingredient ingredientBlankMold = Ingredient.fromStacks(new ItemStack(TNFCItems.mold_blank));
        ...
        MetalPressRecipe.addRecipe(new ItemStack(TNFCItems.mold_block, 1), ingredientBlankMold, new ItemStack(IEContent.blockStorage, 1, 8), 2400);
        MetalPressRecipe.addRecipe(new ItemStack(TNFCItems.mold_doubleingot, 1), ingredientBlankMold, new ItemStack(ItemMetal.get(Metal.STEEL, Metal.ItemType.DOUBLE_INGOT), 1), 2400);
        MetalPressRecipe.addRecipe(new ItemStack(TNFCItems.mold_sheet, 1), ingredientBlankMold, new ItemStack(ItemMetal.get(Metal.STEEL, Metal.ItemType.SHEET), 1), 2400);
