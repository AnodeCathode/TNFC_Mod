...
import tnfcmod.qfc.api.module.FeatureEvent;
import tnfcmod.qfc.api.module.IFeature;
import tnfcmod.qfc.api.module.IModule;
		...
		forEachFeature(feature -> {
			...
			if(!feature.forceLoad && GlobalConfig.enableAntiOverlap) {
				...
				if(incompatibilities != null) {
					...
					if(!failures.isEmpty())
						tnfcmod.tnfcmod.getLog().info("'" + feature.configName + "' is forcefully disabled as it's incompatible with the following loaded mods: " + failures);
				}
			}
