...
public class FireworksRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    ...
    public boolean matches(InventoryCrafting inv, World worldIn)
    {
        ...
        for (int k1 = 0; k1 < inv.getSizeInventory(); ++k1)
        {
            ...
            if (!itemstack.isEmpty())
            {
                ...
                else if (itemstack.getItem() == ItemGem.get(Gem.DIAMOND))
                {
                    ++i1;
                }
                ...
                else if (itemstack.getItem() == ItemMetal.get(Metal.GOLD, Metal.ItemType.NUGGET ))
                {
                    ++j1;
                }
                else
            ...
            else if (j == 1 && i == 0 && l == 0 && k > 0 && j1 <= 1)
            {
                ...
                for (int l1 = 0; l1 < inv.getSizeInventory(); ++l1)
                {
                    ...
                    if (!itemstack2.isEmpty())
                    {
                        ...
                        else if (itemstack2.getItem() == ItemGem.get(Gem.DIAMOND))
                        {
                        ...
                        else if (itemstack2.getItem() == ItemMetal.get(Metal.GOLD, Metal.ItemType.NUGGET ))
                        {
                            b0 = 2;
                        }
