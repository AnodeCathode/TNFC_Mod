/**
 * This class was created by <mezz>. It's distributed as
...
public class BackpackRecipeTransferHandler implements IRecipeTransferHandler<ContainerBackpack> {
	...
	public BackpackRecipeTransferHandler(IRecipeTransferHandlerHelper handlerHelper) {
		...
		this.transferHelper = new BasicRecipeTransferInfo<>(ContainerBackpack.class, VanillaRecipeCategoryUid.CRAFTING, 1, 4, 9, 63);
	}
