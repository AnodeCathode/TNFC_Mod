...
public class AgedRegistry
{
    ...
    public static void registerAgedDrinks(RegistryEvent.Register<BarrelRecipe> event)
    {
        ...
        RYE_WHISKEY = createAgedDrink("rye_whiskey", TempEffect.WARM, AgedDrinksConfig.General.warmTicks, 1);
        ...
        BEER = createAgedDrink("beer", TempEffect.COOL, AgedDrinksConfig.General.coolTicks, 1);
